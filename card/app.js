...
]; // Array to store player's deck of cards
...
{"card_number": 38, "card_name": "Shield Bearer", "health": 35, "damage": 0, "range": 1, "image": "card/shieldbearer.jpg"}, 
{"card_number": 39, "card_name": "Shield Bearer", "health": 35, "damage": 0, "range": 1, "image": "card/shieldbearer.jpg"},
{"card_number": 40, "card_name": "Paladin", "health": 30, "damage": 15, "range": 1, "image": "card/paladin.jpg"}]; // Array to store enemy's deck of cards
var cards = [];
...
function initializeGame() {
  ...
  // Divide the shuffled cards between player and enemy decks
  playerDeck = cards.slice(0, 20);
  enemyDeck = cards.slice(20, 40);
...
function playCard(event) {
  ...
  if (cardIndex !== -1) {
    ...
    var battlefieldElement = document.getElementById('P.A1'); // Assuming the first available slot is used
...
function enemyTurn() {
  var enemyHand = document.getElementsByClassName('enemy hand')[0];
  ...
  if (enemyHand.childElementCount === 0) {
    ...
    if (enemyDeck.length > 0) {
      ...
      var enemyHandElement = document.getElementById('E.A1'); // Assuming the first available slot is used
